...
declare
  ...
  effective_liters_limit numeric;
  already_fueled_liters numeric;
...
begin
  ...
  loop
    ...
    effective_liters_limit := item_liters_limit;
    already_fueled_liters := 0;
    ...
    if existing_fuel_type_limit_row.id is not null
      ...
      effective_liters_limit := already_fueled_liters + item_liters_limit;
    end if;
