-- One-off production fix: allow staff accounts to sign in with email and password only.
-- This mirrors migration 20260710210000_remove_staff_aal2_requirement.sql.
